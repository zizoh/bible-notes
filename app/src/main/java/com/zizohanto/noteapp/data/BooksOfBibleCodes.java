...
public final class BooksOfBibleCodes {

    /**
     * This method returns a HashMap containing pair of strings representing OSIS codes of books of the Bible
     *
     * @return A HashMap of books of the Bible codes
     */
    public static Map<String, String> getBookOfBibleCodes() {
